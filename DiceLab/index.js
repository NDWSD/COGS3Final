...
var die1, die2, dieSum, balance, banner, outcome, die1Name, die2Name, numRolls, roundCount; // define variables
...
function numPlay() {
  numRolls = prompt("How many rolls do you want to do?");
  document.querySelector("h3").innerHTML=""; 
}

function rollDice() {
  //alert("inside rollDice")
...
function whoWon() {
    ...
    document.querySelector("h3").innerHTML = document.querySelector("h3").innerHTML + "<p> Roll " + roundCount + ": <br>" + banner + "<br>" + outcome;
}
